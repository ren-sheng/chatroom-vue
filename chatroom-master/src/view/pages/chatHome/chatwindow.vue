<template>
  <div class="chat-window">
    <div class="top">
      <div class="head-pic">
        <HeadPortrait :imgUrl="friendInfo.headImg" :isOnline="friendInfo.isOnline"></HeadPortrait>
      </div>
    ...
    <div class="botoom">
      <div class="chat-content" ref="chatContent">
        <div class="chat-wrapper" v-for="item in chatList" :key="item.id">
          <div class="chat-friend" v-if="item.uid == friendInfo.id">
  ...
  created() {
    ...
    this.$root.ws.onmessage = (event) => {
      ...
      if (message.sender == this.$store.state.userId) {
        ...
        img = this.friendInfo.headImg
        nowname = this.friendInfo.name
